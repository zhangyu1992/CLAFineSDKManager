...
//录音停止事件的block回调，作用参考MLAudioRecorderDelegate的recordStopped和recordErrorHandle:
 ...
 */
- (void)recordErrorHandle:(NSError *)error;
 ...
 *  外部录音计时与内部实际开始值不一样
 */
- (void)recordStarted:(NSDate *)startDate;
 ...
 *  处理写文件操作的，实际是转码的操作在其中进行。算作可扩展自定义的转码器
 */
@property (nonatomic, assign) id<FileWriterForMLAudioRecorder> fileWriterDelegate;
