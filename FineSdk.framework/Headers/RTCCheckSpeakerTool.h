...
@protocol RTCCheckSpeakerToolDelegate <NSObject>
...
@interface RTCCheckSpeakerTool : NSObject
@property (nonatomic, weak) id<RTCCheckSpeakerToolDelegate> speakerDelegate;
