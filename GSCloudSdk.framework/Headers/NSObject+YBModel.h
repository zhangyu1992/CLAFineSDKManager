//
//  NSObject+GYBModel.h
//  GYBModel <https://github.com/ibireme/GYBModel>
//
 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `GYBModel` protocol for custom methods.
 ...
 Sample Code:
     ...
     ********************** json convertor *********************
 @code
     @interface GYBAuthor : NSObject
     @property (nonatomic, strong) NSString *name;
     @property (nonatomic, assign) NSDate *birthday;
     @end
     @implementation GYBAuthor
     @end
 
     @interface GYBBook : NSObject
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) NSUInteger pages;
     @property (nonatomic, strong) GYBAuthor *author;
     @end
     @implementation GYBBook
     @end
    
     int main() {
         // create model from json
         GYBBook *book = [GYBBook yb_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
         // convert model to json
         NSString *json = [book yb_modelToJSONString];
 ...
 @code
     @interface GYBShadow :NSObject <NSCoding, NSCopying>
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) CGSize size;
     @end
 
     @implementation GYBShadow
     - (void)encodeWithCoder:(NSCoder *)aCoder { [self yb_modelEncodeWithCoder:aCoder]; }
     - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self yb_modelInitWithCoder:aDecoder]; }
     - (id)copyWithZone:(NSZone *)zone { return [self yb_modelCopy]; }
     - (NSUInteger)hash { return [self yb_modelHash]; }
     - (BOOL)isEqual:(id)object { return [self yb_modelIsEqual:object]; }
     @end
 @endcode
 
 */
@interface NSObject (GYBModel)
 ...
 */
+ (nullable instancetype)yb_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> NSDate, parsed with format "GYBGYB-MM-dd'T'HH:mm:ssZ", "GYBGYB-MM-dd HH:mm:ss" or "GYBGYB-MM-dd".
     `NSString` -> NSURL.
     `NSValue` -> struct or union, such as CGRect, CGSize, ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)yb_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (BOOL)yb_modelSetWithJSON:(id)json;
...
/**
 ...
 @return Whether succeed.
 */
- (BOOL)yb_modelSetWithDictionary:(NSDictionary *)dic;
 ...
 */
- (nullable id)yb_modelToJSONObject;
 ...
 */
- (nullable NSData *)yb_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)yb_modelToJSONString;
 ...
 */
- (void)yb_modelEncodeWithCoder:(NSCoder *)aCoder;
...
/**
 ...
 @return self
 */
- (id)yb_modelInitWithCoder:(NSCoder *)aDecoder;
 ...
 */
+ (nullable NSArray *)yb_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (GYBModel)
 ...
 */
+ (nullable NSDictionary *)yb_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<GYBModel>' to your class header.
 */
@protocol GYBModel <NSObject>
@optional
...
/**
 ...
 object will be add to the array/set/dictionary.
  ...
  Example:
  @code
        @class GYBShadow, GYBBorder, GYBAttachment;
 
        @interface GYBAttributes
        @property NSString *name;
        ...
        @implementation GYBAttributes
        + (NSDictionary *)modelContainerPropertyGenericClass {
            return @{@"shadows" : [GYBShadow class],
                     @"borders" : GYBBorder.class,
                     @"attachments" : @"GYBAttachment" };
        }
        @end
  @endcode
...
/**
 ...
 Example:
 @code
        @class GYBCircle, GYBRectangle, GYBLine;
 
        @implementation GYBShape

        + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [GYBCircle class];
            } else if (dictionary[@"width"] != nil) {
                return [GYBRectangle class];
            } else if (dictionary[@"y2"] != nil) {
                return [GYBLine class];
            } else {
                return [self class];
            }
        }
